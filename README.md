...
NOTE: I use MSYS2 with make and dub to build the game. MSYS2 and make aren't not necessary but run the commands I need and makes it a little easier to compile. The project uses the latest SDL2 DLLs available from UCRT64 packages.
