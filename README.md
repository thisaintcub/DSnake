...
NOTE: I use MSYS2 with make and dub to build the game. MSYS2 is not necessary but runs the commands I need and makes it a little easier to compile. The project uses the latest SDL2 DLLs available from UCRT64 packages.
